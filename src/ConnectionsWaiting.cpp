...
ConnectionsWaiting::~ConnectionsWaiting() { connectionsWaiting.clear(); }

void ConnectionsWaiting::lock() { pad.lock(); }

void ConnectionsWaiting::unlock() { pad.unlock(); }
...
void ConnectionsWaiting::signal() { sem.post(); }

void ConnectionsWaiting::wait() { sem.wait(); }

...
Connection::~Connection() { delete protocol; }

int Connection::getSocket() { return socket.getSocket(); }

std::string Connection::getID() { return uniqueID; }

std::string Connection::getSocket_str() { return socket.getSocket_str(); }
...
int Connection::close() { return socket.close(); }
...
const std::string Connection::getBuffer() { return buffer; }
